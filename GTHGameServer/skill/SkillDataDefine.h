#ifndef _SKILL_DATA_DEFINE_H
#define _SKILL_DATA_DEFINE_H
...
enum
{
	...
	SKILL_AFFDATA_TYPE_ATTACKSPEEDRATE_DEC ,			
...
enum
{
	SKILL_AFF_SPE_IS_TRANSFORM_TRUE=1,
	SKILL_AFF_SPE_IS_TRANSFORM_FALSE,

	NUM_OF_SKILL_AFF_SPE_IS_TRANSFORM,
};

enum
{
	SKILL_AFF_SPE_TRANSFORM_NORMAL		=	1,		
	SKILL_AFF_SPE_TRANSFORM_ETHEREAL,					

	NUM_OF_SKILL_AFF_TRANSFORM_TYPE,
};
...
enum
{
	MSG_RANGE_TYPE_TARGET		=	0,
	MSG_RANGE_TYPE_EXCEPT_TARGET,
	MSG_RANGE_TYPE_MYSELF,
	MSG_RANGE_TYPE_EXCEPT_PARTY,
};
